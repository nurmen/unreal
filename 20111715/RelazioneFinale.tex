...
\subsubsection{Settimane VII-VIII}
\label{3.1.4}
...
Il sistema deve essere in grado di elaborare il valore che descrive la correlazione e classificare la firma in input di conseguenza.
