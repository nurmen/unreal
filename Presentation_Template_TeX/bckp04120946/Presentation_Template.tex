...
{
  {\LARGE Università degli studi di Padova}\\[0.3cm]
...
\framesubtitle{Obiettivo e difficoltà}
%\transboxin
...
\begin{center}
\begin{itemize}
  		\item<1-> Obiettivo: Decidere se una firma è autentica/falsa
  		\item<2-> Variazioni intrapersonali: Le firme personali possiedono grande variabilità, dovuta allo stato emotivo dei sottoscrittori, alla posizione di raccolta, ecc...
...
\end{center}
\vspace{-15pt}\uncover<2->{\begin{exampleblock}{Requisito di qualità}
\begin{itemize}
...
\item<8-> vale la \emph{proprietà di Markov}:\\
