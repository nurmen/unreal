...
\label{2.1.3}
La verifica di firme statiche appartiene ai problemi del pattern recognition e un tipico sistema di pattern recognition si compone dei seguenti step \cite{2698894}:
\begin{description}
\item[(i)] Acquisizione dati, cattura delle immagini firma;
\item[(ii)] Preprocessing, (to simplify subsequent operations without loosing relevant processing);
\item[(iii)] Estrazione delle feature,
\item[(iv)] Classificazione
\end{description}
Processo di classificazione generale.
2698894
Features.
